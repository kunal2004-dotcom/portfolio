  ...
  return (
    ...
    <body className='min-h-screen md:px-36 md:py-16 md:pb-4 px-8 py-12 bg-[white] select-none md:w-6/12 md:pr-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]'>
      <div className='text-center'>
        ...
        <br />
        <h1 className='text-left font-medium text-7xl md:text-8xl font-rubix bg-gradient-to-r from-[#833be7cb] to-[#5521c5] bg-clip-text text-transparent'>Kunal</h1>
        <h1 className='text-left md:pb-6 pt-2 md:pt-0 pb-7 leading-10 font-semibold text-6xl md:text-7xl font-rubix'>Bagad</h1>
      ...
      <div className="flex md:p-6 pt-4 space-x-2.5 w-full md:pt-8 md:pb-8">
        <a className='pl-2 h-10 w-10 text-center border pt-2 rounded-md border-black hover:bg-[#c580f023] transition-all duration-500 active:bg-zinc-300' href="https://www.linkedin.com/in/kunal-bagad/">
          <LuLinkedin size={23} />
        </a>
        <a className='pl-2 h-10 w-10 text-center border pt-2 rounded-md border-black hover:bg-[#c580f023] transition-all duration-500 active:bg-zinc-300' href="https://www.instagram.com/kunal_bagad_/">
          <LuInstagram size={23} />
        </a>
      </div>
      <div>
